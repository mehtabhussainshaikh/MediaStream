...
export function MediaPage() {
  ...
  const change = (name, value) => { setParams((current) => { if (value && value !== defaults[name]) current.set(name, value); else current.delete(name); if (name !== 'page') current.delete('page'); return current; }); };
